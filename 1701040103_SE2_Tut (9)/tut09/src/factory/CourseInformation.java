...
class CourseInformation {
	public static void main(String args[]) throws IOException {
        ...
        Courses c = newApplication.admittingCourse(cousreName);
        System.out.print("For  " + cousreName + "  the required duration you would have to study is: ");
        c.getDuration();
        System.out.print("For  " + cousreName + "  the required fee you would have to pay per semester is: ");
        c.getFeePerSemester();
